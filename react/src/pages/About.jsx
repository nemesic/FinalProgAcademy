export default function About() {
  return (
    <div className="about-page w-full min-h-screen flex justify-center items-center bg-transparent">
      <div className="about-card flex flex-col items-center justify-center animate-about-fade-in">
        <div className="about-svg mb-4">
        ...
        >
          ...
          <span>github/FinalProgAcademy/react</span>
        </a>
      </div>
    </div>
  );
